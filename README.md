...
This project predicts the species of Iris flowers based on sepal and petal measurements. The main objectives are: • Understand and visualize the Iris dataset • Preprocess data for Machine Learning • Train and evaluate classifiers • Interpret results using confusion matrices and accuracy metrics
...
Clone this repository: git clone https://github.com/AaryaaDahal/Iris-Flower-Species-Prediction.git 
...
The notebook demonstrates training using multiple classifiers: • Logistic Regression – simple linear classifier 
